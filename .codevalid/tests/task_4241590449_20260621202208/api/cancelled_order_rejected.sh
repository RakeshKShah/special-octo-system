...
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -c "INSERT INTO \"Order\" (id, \"buyerId\", status, \"createdAt\", \"updatedAt\") VALUES ('$ORDER_ID', '$BUYER_USER_ID', 'CANCELLED', NOW(), NOW())" >/dev/null
