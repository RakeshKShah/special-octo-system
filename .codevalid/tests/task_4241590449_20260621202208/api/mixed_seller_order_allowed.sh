...
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -c "INSERT INTO products (id, seller_id, title, description, category, price_cents, stock_qty, photos, status, visible) VALUES ('$PRODUCT1_ID', '$SELLER1_PROFILE_ID', 'Product 1 $CASE_SUFFIX', 'Seeded product', 'GENERAL', 2500, 5, '[]', 'ACTIVE', true)" >/dev/null
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -c "INSERT INTO products (id, seller_id, title, description, category, price_cents, stock_qty, photos, status, visible) VALUES ('$PRODUCT2_ID', '$SELLER2_PROFILE_ID', 'Product 2 $CASE_SUFFIX', 'Seeded product', 'GENERAL', 2600, 5, '[]', 'ACTIVE', true)" >/dev/null
