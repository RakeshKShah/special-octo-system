...
SELLER_EMAIL="seller-pending-${CASE_SUFFIX}@example.com"
PRODUCT_ID="prod-pending-${CASE_SUFFIX}"
ORDER_ITEM_ID="order-item-pending-${CASE_SUFFIX}"
SELLER_TOKEN=""
SELLER_USER_ID=""
SELLER_PROFILE_ID=""
BUYER_USER_ID=""
...
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -c "INSERT INTO \"Order\" (id, \"buyerId\", status, \"createdAt\", \"updatedAt\") VALUES ('$ORDER_ID', '$BUYER_USER_ID', 'PENDING', NOW(), NOW())" >/dev/null
