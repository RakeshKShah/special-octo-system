...
BUYER_EMAIL="buyer-inactive-${CASE_SUFFIX}@example.com"
SELLER_EMAIL="seller-inactive-${CASE_SUFFIX}@example.com"
PRODUCT_ID="prod-inactive-${CASE_SUFFIX}"
ORDER_ITEM_ID="order-item-inactive-${CASE_SUFFIX}"
SELLER_TOKEN=""
SELLER_USER_ID=""
SELLER_PROFILE_ID=""
BUYER_USER_ID=""
...
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -c "UPDATE \"User\" SET status = 'INACTIVE' WHERE id = '$SELLER_USER_ID'" >/dev/null
